...
function bindEvents() {
  ...
  if (dom.analyzeVideoBtn) {
    dom.analyzeVideoBtn.addEventListener("click", handleAnalyzeVideo);
  }
  if (dom.libraryUploadBtn) {
    dom.libraryUploadBtn.addEventListener("click", handleLibraryUpload);
  }
  if (dom.uploadSort) {
